...
- 当前保留的胡法/结算范围为平胡、自摸、三金倒、游金、双游、三游、八花游、花牌计分和连庄/底分。门清、碰碰胡、清一色、混一色及类似复杂组合不计独立番型，也不是 AI 目标；其牌张仍可按标准结构组成普通胡。
...
4. 抢金、三金倒、八花游、游金链、抢杠、加杠细节、杠分与流局杠分均未实现。八花游存在、花牌基础1番和部分游金对手权限已确认；其余触发、倍率、叠加与响应窗口继续保持 UNKNOWN。
