...
- 后续AI实验：V0.7a（loss-index优先）未通过；V0.7b（risk优先、loss次级）在独立确认中优势消失；64模板相对32模板无稳定收益；V0.8确定性二阶牌效首轮100 pair为+26.67且95%CI>0，但独立100 pair为-5.25，合并200 pair平均+10.71、95%CI -9.38～+30.80，因此不晋级。当前正在做决策级影子诊断，查明V0.8在哪些向听/平局状态改变V0.6选择。证据归档见 `references/ai/2026-09-19/`。
...
- Core regression：Python 3.10 / 3.11 / 3.12 **各286项通过，0失败、0错误**。Legacy Core V0.1.1与Legacy Environment V0.1同样通过。
