...
2. 普通真实 Settlement + MatchRunner 已接通。无独立杠费后，同口径20场中6/20完整跑完8局；共完成87个真实结算单局，平均4.35局/场。UNKNOWN累计：decomposition_scoring 9、three_plus_gold_discard_hu 3、exposed_triplet_fan 2。下一步首要补多拆解取番，其次3+金点炮和普通数牌碰牌番。
