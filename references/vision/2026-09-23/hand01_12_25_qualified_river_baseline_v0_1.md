...
- Both actor-specific `DiscardRiverObserver`s established a baseline and emitted
  **2 upper/opponent + 2 lower/player** river-growth observations. The assembler
  produced **4** `DISCARD`-kind outputs, all with tile and independent turn
  **UNKNOWN**. A single untrusted player frame (685) was withheld when touching
...
|---:|---|---|---|---|
| 14.068966 | opponent (upper) | DISCARD candidate | UNKNOWN/UNKNOWN | abstain |
...
Only the anonymous reviewed zones and sanitized counts in this directory may
