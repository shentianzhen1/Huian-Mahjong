...
- **八花游触发与结算已确认。** 玩家2026-09-18确认：只要集齐全部8张花牌，即具备八花游资格，不要求手牌满足普通胡结构，可直接作为特殊胡结束本局；玩家也可选择【过】不走八花游。若选择过，8张花牌按基础花番1番/张计算，共8番，之后继续普通牌局。若直接选择八花游胡，八花游本身**不额外加倍**，沿用正常结算规则，不增加专属乘数；庄位也按正常胜负流程处理。
