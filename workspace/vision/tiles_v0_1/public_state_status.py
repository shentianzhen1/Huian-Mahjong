...
def _trim_remaining_right_edge(image):
    """Trim only the likely following-glyph edge for fallback OCR.

    This is deliberately used only after the primary parse is invalid; a
    physically valid primary value is never replaced.
    """
