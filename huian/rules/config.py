...
UNKNOWN_RULES = MappingProxyType({
    ...
    "youjin_response_hu_extra_tiles": "How later Double-/Triple-You response self-Hu is structurally checked when earlier missed response draws remain in the opponent hand",
