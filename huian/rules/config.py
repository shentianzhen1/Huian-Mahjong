...
UNKNOWN_RULES = MappingProxyType({
    ...
    "pass_transition": "Transition after all claims are declined",
    ...
    "wall_boundary": "Exact 16-tile check timing and replacement exceptions",
    ...
    "three_plus_gold_pinghu": "Ordinary discard win with three or more golds",
