...
UNKNOWN_RULES = MappingProxyType({
    ...
    "youjin_permissions": "Remaining stage-success/upgrade/cancellation timing and Chi/Peng/Kong/flower interactions; one-draw self-Hu interception is confirmed",
