...
UNKNOWN_RULES = MappingProxyType({
    ...
    "youjin_permissions": "Remaining Double-/Triple-You upgrade/cancellation timing and Chi/Peng/Kong interactions; single-Youjin entry and one-draw self-Hu interception are now executable",
    ...
    "youjin_stage_success_resolution": "Terminal/settlement timing after the opponent's one allowed draw cannot self-draw Hu; current Youjin stage success itself is confirmed",
