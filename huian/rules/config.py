...
UNKNOWN_RULES = MappingProxyType({
    ...
    "sanjindao_settlement": "Multiplier, payment and dealer result after declaration",
    "sanjinyou_trigger": "Exact executable steps shared by Erjin-You and Sanjin-You",
    "sanjinyou_multiplier": "Target-room Sanjin-You multiplier and settlement",
    "sanjinyou_relation": "Naming/state relation between Sanjin-You and Triple-You",
    ...
    "room_multipliers": "Room-specific multipliers for all win types",
