...
- 已确认待统一实现：花牌1番/张线性累加，4张=4番，四花成组不额外叠加；集齐8张花即具备八花游资格，不要求普通牌型，可直接特殊胡，也可选择【过】。若过掉八花游，8张花按基础花番合计8番，继续走普通胡。本轮不改代码、不跑测试。
- 下一步证据优先级：① 大明杠/暗杠/补杠是否有独立即时杠费、流局是否保留；② 普通数牌碰牌番；③ 多拆解同手牌的取番规则；④ 八花游特殊胡的倍率/付款/下局庄位；⑤ 抢杠胡/杠胡等特殊结算。
